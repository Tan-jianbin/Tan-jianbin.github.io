...
<div class="project-item">
  ...
  <p class="project-summary">
    This project develops statistical methods for environmental daily curves, commonly referred to as functional time series, which exhibit complex multi-way
