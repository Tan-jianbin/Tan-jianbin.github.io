...
My research interest lies in the topic of statistical modeling and analysis for ***data with complex mechanisms and structures***, particularly for  ***functional, dynamic, high-dimensional, tensor, spatiotemporal, longitudinal, and graphical-correlated data***. 
