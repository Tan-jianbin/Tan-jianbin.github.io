...
My research interests lie in machine learning, generative modeling, and computational algorithms for ***data with dynamic, spatial, or functional structures***. Specifically, I focus on the statistical analysis of ***dynamic, spatiotemporal, high-dimensional longitudinal, and high-dimensional functional time series data***, with applications in ***biological, health, epidemiological, and environmental sciences***.
