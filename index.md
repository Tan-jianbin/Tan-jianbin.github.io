...
My research interest lies in statistical learning and algorithms for data with ***complex mechanisms, dependencies, heterogeneity, and functional structures.*** Specifically, I have focused on statistical analysis of dynamic, spatiotemporal, and high-dimensional longitudinal / functional time series data, with applications to ***biological, health, epidemiological, and environmental sciences***. 
