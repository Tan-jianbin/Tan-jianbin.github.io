...
My research interest lies in developing new methods for analyzing data with complex ***mechanisms, dependencies, heterogeneity, and trajectory structures***. Specifically, I have focused on statistical analysis of dynamic, spatiotemporal, and high-dimensional longitudinal/curve time series data, with applications to ***biological, health, epidemiological, and environmental sciences***.
