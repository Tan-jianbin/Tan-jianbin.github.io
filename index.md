...
My research interests lie in machine learning, generative modeling, and computational algorithms for ***complex data with dynamic, spatial, or functional structures***. Specifically, I focus on the analysis of ***dynamic, spatiotemporal, high-dimensional longitudinal/functional time series data***, with applications in ***biological, health, epidemiological, and environmental sciences***.
