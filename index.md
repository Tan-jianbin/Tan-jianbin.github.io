...
My research interest lies in the topic of statistical modelling and analysis for ***data with intricate structures, complex dependencies, and unidentified mechanisms***, particularly including  ***functional, dynamic, high-dimensional, tensor, spatiotemporal, longitudinal, and process-valued data***. 
